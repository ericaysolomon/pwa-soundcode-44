...
const PHONEMES = [
  ...
  { id:'vowel_diph_oor', num:20, ipa:'ʊə', name:'OOR / CURE',   sub:'Diphthong',     cat:'di', file:'vowel_diph_oor',
    ...
    patterns:[{sp:'ure',words:['cure','pure','sure','lure']},{sp:'our',words:['tour','detour','velour','contour']},{sp:'oor',words:['poor','moor']},{sp:'ewer',words:['fewer','sewer']}],
  ...
  { id:'cons_v', num:28, ipa:'v', name:'V',  sub:'Voiced Fricative',   cat:'fr', file:'cons_v',
    ...
    patterns:[{sp:'v',words:['van','vine','love','vest']},{sp:'ve',words:['give','live','love','have']},{sp:'f',words:['of']}],
  ...
  { id:'cons_z', num:32, ipa:'z', name:'Z',  sub:'Voiced Fricative',   cat:'fr', file:'cons_z',
    ...
    patterns:[{sp:'z',words:['zip','zoo','zero','zone']},{sp:'zz',words:['buzz','jazz','fizz','fuzz']},{sp:'s',words:['dogs','rose','nose','easy']},{sp:'se',words:['cheese','these','ease','tease']},{sp:'ze',words:['squeeze','breeze','freeze','sneeze']},{sp:'x',words:['xylophone']}],
  ...
  { id:'cons_sh', num:33, ipa:'ʃ', name:'SH', sub:'Voiceless Fricative', cat:'fr', file:'cons_sh',
    ...
    patterns:[{sp:'sh',words:['ship','shoe','fish','wish']},{sp:'ch',words:['chef','machine','chic','champagne']},{sp:'ti',words:['nation','station','action','mention']},{sp:'ssi',words:['mission','passion','permission','expression']},{sp:'ci',words:['special','social','official','ancient']},{sp:'si',words:['tension','version','pension','mansion']},{sp:'s',words:['sugar','sure']}],
  ...
  { id:'cons_w', num:43, ipa:'w', name:'W',  sub:'Approximant',         cat:'ap', file:'cons_w',
    ...
    patterns:[{sp:'w',words:['water','wet','swim','win']},{sp:'wh',words:['when','where','which','wheel']},{sp:'u',words:['queen','quiet','quiz','quick']},{sp:'o',words:['one','once']}],
