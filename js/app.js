...
const PHONEMES = [
  ...
  { id:'vowel_short_e',  num:2,  ipa:'e',  name:'Short E',      sub:'Short Vowel',   cat:'ms', file:'vowel_short_e',
    ...
    patterns:[{sp:'e',words:['bed','red','ten','pet']},{sp:'ea',words:['head','dead','bread','thread']},{sp:'ai',words:['said','again']},{sp:'a',words:['many','any']},{sp:'ie',words:['friend']}]},{sp:'ea',words:['head','dead','bread','thread']}],
  ...
  { id:'vowel_short_i',  num:3,  ipa:'ɪ',  name:'Short I',      sub:'Short Vowel',   cat:'ms', file:'vowel_short_i',
    ...
    patterns:[{sp:'i',words:['sit','bit','tip','pin']},{sp:'y',words:['gym','myth','busy']},{sp:'ui',words:['build','guilt']},{sp:'o',words:['women']}]},{sp:'y',words:['gym','myth','crystal']}],
  ...
  { id:'vowel_short_o',  num:4,  ipa:'ɒ',  name:'Short O',      sub:'Short Vowel',   cat:'ms', file:'vowel_short_o',
    ...
    patterns:[{sp:'o',words:['hot','dog','lot','fox']},{sp:'a',words:['want','wash','what','was']}]},{sp:'a',words:['want','wash','what','was']}],
  ...
  { id:'vowel_short_u',  num:5,  ipa:'ʌ',  name:'Short U',      sub:'Short Vowel',   cat:'ms', file:'vowel_short_u',
    ...
    patterns:[{sp:'u',words:['cup','bus','run','mud']},{sp:'o',words:['son','come','love','above']},{sp:'oo',words:['blood','flood']},{sp:'ou',words:['young','touch']}]},{sp:'o',words:['son','come','love','dove','above']}],
  ...
  { id:'vowel_short_oo', num:6,  ipa:'ʊ',  name:'Short OO',     sub:'Short Vowel',   cat:'ms', file:'vowel_short_oo',
    ...
    patterns:[{sp:'oo',words:['book','look','foot','good']},{sp:'u',words:['put','push','pull','full']},{sp:'ou',words:['should','could']},{sp:'o',words:['wolf','woman']}]},{sp:'u',words:['put','push','pull','full','bull','bush']}],
  ...
  { id:'vowel_schwa',    num:7,  ipa:'ə',  name:'Schwa',         sub:'Unstressed Vowel',cat:'ms', file:'vowel_schwa',
    ...
    patterns:[{sp:'a',words:['about','ago','banana','afraid']},{sp:'e',words:['open','happen','broken','listen']},{sp:'o',words:['bacon','lesson','button','person']},{sp:'i',words:['pencil','animal']},{sp:'u',words:['supply','circus']},{sp:'ou',words:['famous','colour']}]},{sp:'e',words:['open','given','happen','broken','listen']},{sp:'o',words:['bacon','lesson','button','reason','person']}],
  ...
  { id:'vowel_long_ee',  num:8,  ipa:'iː', name:'Long EE',      sub:'Long Vowel',    cat:'ml', file:'vowel_long_ee',
    ...
    patterns:[{sp:'ee',words:['see','tree','feet','bee']},{sp:'ea',words:['meat','read','beach','dream']},{sp:'e',words:['he','she','me','we']},{sp:'e-e',words:['these','theme','here','scene']},{sp:'ie',words:['field','piece']},{sp:'ey',words:['key','money']},{sp:'y',words:['funny','baby']}]},{sp:'ea',words:['meat','read','beach','clean','dream']},{sp:'e',words:['he','she','me','we','be']},{sp:'e-e',words:['these','theme','here','scene']}],
  ...
  { id:'vowel_long_ar',  num:9,  ipa:'ɑː', name:'Long AR',      sub:'Long Vowel',    cat:'ml', file:'vowel_long_ar',
    ...
    patterns:[{sp:'ar',words:['car','far','star','park']},{sp:'a',words:['bath','path','grass','fast']},{sp:'al',words:['half','calf']},{sp:'ear',words:['heart','hearth']}]},{sp:'a',words:['bath','path','grass','fast','last','past']}],
  ...
  { id:'vowel_long_aw',  num:10, ipa:'ɔː', name:'Long AW',      sub:'Long Vowel',    cat:'ml', file:'vowel_long_aw',
    ...
    patterns:[{sp:'aw',words:['saw','law','draw','lawn']},{sp:'or',words:['born','more','for','floor']},{sp:'al',words:['call','walk','talk','ball']},{sp:'au',words:['caught','fault']},{sp:'oor',words:['floor','door']},{sp:'oar',words:['board','soar']},{sp:'ough',words:['thought','bought']}]},{sp:'or',words:['born','more','for','floor','sport','short']},{sp:'al',words:['call','walk','talk','chalk','hall','wall','ball']}],
  ...
  { id:'vowel_long_oo',  num:11, ipa:'uː', name:'Long OO',      sub:'Long Vowel',    cat:'ml', file:'vowel_long_oo',
    ...
    patterns:[{sp:'oo',words:['moon','food','boot','cool']},{sp:'ue',words:['blue','clue','glue','true']},{sp:'ew',words:['new','few','dew','flew']},{sp:'u-e',words:['rule','tune','cube','rude']},{sp:'ui',words:['fruit','suit']},{sp:'ou',words:['soup','through']},{sp:'o',words:['who','move']}]},{sp:'ue',words:['blue','clue','glue','true','due']},{sp:'ew',words:['new','few','dew','flew','grew','chew']},{sp:'u-e',words:['rule','tune','cube','rude','flute']}],
  ...
  { id:'vowel_long_er',  num:12, ipa:'ɜː', name:'Long ER',      sub:'Long Vowel',    cat:'ml', file:'vowel_long_er',
    ...
    patterns:[{sp:'er',words:['her','fern','verb','herd']},{sp:'ir',words:['bird','girl','sir','first']},{sp:'ur',words:['turn','burn','fur','hurt']},{sp:'ear',words:['learn','earth']},{sp:'or',words:['word','work']},{sp:'our',words:['journey','courage']}]},{sp:'ir',words:['bird','girl','sir','stir','first','shirt','skirt']},{sp:'ur',words:['turn','burn','fur','hurt','curve','nurse','purse']}],
  ...
  { id:'vowel_diph_ay',  num:13, ipa:'eɪ', name:'Long A / AY',  sub:'Diphthong',     cat:'di', file:'vowel_diph_ay',
    ...
    patterns:[{sp:'ay',words:['day','play','say','stay']},{sp:'ai',words:['rain','wait','train','sail']},{sp:'a-e',words:['cake','name','late','game']},{sp:'a',words:['table','baby']},{sp:'ea',words:['great','break']},{sp:'ey',words:['they','grey']},{sp:'eigh',words:['eight','weight']}]},{sp:'ai',words:['rain','wait','train','brain','mail','sail','tail']},{sp:'a-e',words:['cake','name','late','game','same','gave']}],
  ...
  { id:'vowel_diph_eye', num:14, ipa:'aɪ', name:'Long I / EYE',  sub:'Diphthong',     cat:'di', file:'vowel_diph_eye',
    ...
    patterns:[{sp:'i-e',words:['time','like','bike','fine']},{sp:'igh',words:['high','night','light','right']},{sp:'y',words:['my','sky','fly','try']},{sp:'i',words:['find','kind']},{sp:'ie',words:['pie','die']},{sp:'ye',words:['bye','rye']},{sp:'ei',words:['height','either']}]},{sp:'igh',words:['high','night','light','right','might','bright','flight']},{sp:'y',words:['my','sky','fly','by','try','cry','dry']}],
  ...
  { id:'vowel_diph_oh',  num:15, ipa:'əʊ', name:'Long O / OH',  sub:'Diphthong',     cat:'di', file:'vowel_diph_oh',
    ...
    patterns:[{sp:'o-e',words:['home','bone','stone','note']},{sp:'oa',words:['boat','road','coat','load']},{sp:'ow',words:['low','slow','grow','know']},{sp:'o',words:['go','so']},{sp:'oe',words:['toe','foe']},{sp:'ou',words:['soul','though']}]},{sp:'oa',words:['boat','road','coat','load','foam','groan']},{sp:'ow',words:['low','slow','grow','flow','blow','know','show']}],
  ...
  { id:'vowel_diph_ow',  num:16, ipa:'aʊ', name:'OW / OW',      sub:'Diphthong',     cat:'di', file:'vowel_diph_ow',
    ...
    patterns:[{sp:'ow',words:['now','cow','down','town']},{sp:'ou',words:['house','out','loud','cloud']},{sp:'ough',words:['plough']}]},{sp:'ou',words:['house','out','loud','cloud','ground','found','round','mouth']}],
  ...
  { id:'vowel_diph_oy',  num:17, ipa:'ɔɪ', name:'OY / OI',      sub:'Diphthong',     cat:'di', file:'vowel_diph_oy',
    ...
    patterns:[{sp:'oy',words:['boy','toy','joy','enjoy']},{sp:'oi',words:['coin','oil','soil','voice']}]},{sp:'oi',words:['coin','oil','soil','foil','coil','boil','join','voice']}],
  ...
  { id:'vowel_diph_air', num:18, ipa:'eə', name:'AIR',           sub:'Diphthong',     cat:'di', file:'vowel_diph_air',
    ...
    patterns:[{sp:'air',words:['air','hair','fair','chair']},{sp:'are',words:['care','dare','share','stare']},{sp:'ear',words:['bear','pear','wear','swear']},{sp:'ere',words:['where','there']},{sp:'eir',words:['their']}]},{sp:'are',words:['care','dare','fare','hare','rare','share','spare','stare']},{sp:'ear',words:['bear','pear','wear','swear']}],
  ...
  { id:'vowel_diph_ear', num:19, ipa:'ɪə', name:'EAR',           sub:'Diphthong',     cat:'di', file:'vowel_diph_ear',
    ...
    patterns:[{sp:'ear',words:['ear','near','year','fear']},{sp:'eer',words:['beer','deer','cheer','sheer']},{sp:'ere',words:['here','mere','severe']},{sp:'ier',words:['pier','fierce']}]},{sp:'eer',words:['beer','deer','peer','steer','cheer','sheer']},{sp:'ere',words:['here','mere','severe','sincere']}],
  ...
  { id:'vowel_diph_oor', num:20, ipa:'ʊə', name:'OOR / CURE',   sub:'Diphthong',     cat:'di', file:'vowel_diph_oor',
    ...
    patterns:[{sp:'ure',words:['cure','pure','sure','lure']},{sp:'our',words:['tour','your']},{sp:'oor',words:['poor','moor']},{sp:'ewer',words:['fewer','sewer']}]},{sp:'our',words:['tour','your','moor','poor']}],
  ...
  { id:'cons_b', num:22, ipa:'b', name:'B',  sub:'Voiced Plosive',    cat:'pl', file:'cons_b',
    ...
    patterns:[{sp:'b',words:['bat','bus','bag','bit']},{sp:'bb',words:['rabbit','bubble','rubber','ribbon']},{sp:'bu',words:['building','buy']}]},{sp:'bb',words:['rabbit','bubble','rubber','lobby','ribbon']}],
  ...
  { id:'cons_t', num:23, ipa:'t', name:'T',  sub:'Voiceless Plosive', cat:'pl', file:'cons_t',
    ...
    patterns:[{sp:'t',words:['tap','ten','sit','hot']},{sp:'tt',words:['butter','better','letter','bottle']},{sp:'ed',words:['walked','jumped','stopped','missed']},{sp:'th',words:['Thomas','thyme']}]},{sp:'tt',words:['butter','better','letter','matter','little','bottle']},{sp:'ed',words:['walked','jumped','stopped','missed']}],
  ...
  { id:'cons_k', num:25, ipa:'k', name:'K',  sub:'Voiceless Plosive', cat:'pl', file:'cons_k',
    ...
    patterns:[{sp:'k',words:['key','king','kind','kit']},{sp:'c',words:['cat','cup','coat','car']},{sp:'ck',words:['back','lock','duck','neck']},{sp:'ch',words:['school','ache']},{sp:'qu',words:['queen','quilt']},{sp:'que',words:['queue','plaque']},{sp:'cc',words:['account','occur']}]},{sp:'c',words:['cat','cup','cut','coat','cool','car','come']},{sp:'ck',words:['back','lock','duck','neck','rack','tick','kick']}],
  ...
  { id:'cons_g', num:26, ipa:'g', name:'G',  sub:'Voiced Plosive',    cat:'pl', file:'cons_g',
    ...
    patterns:[{sp:'g',words:['get','go','dog','leg']},{sp:'gg',words:['egg','giggle','wiggle','bigger']},{sp:'gh',words:['ghost','ghetto']},{sp:'gue',words:['colleague','vague']},{sp:'gu',words:['guard','guest']}]},{sp:'gg',words:['egg','giggle','wiggle','jogger','buggy','bigger']}],
  ...
  { id:'cons_f', num:27, ipa:'f', name:'F',  sub:'Voiceless Fricative', cat:'fr', file:'cons_f',
    ...
    patterns:[{sp:'f',words:['fan','fat','fit','fun']},{sp:'ff',words:['off','cliff','staff','stuff']},{sp:'ph',words:['photo','phone','dolphin','elephant']},{sp:'gh',words:['enough','rough']},{sp:'lf',words:['half','calf']}]},{sp:'ff',words:['off','cliff','staff','stuff','stiff','sniff','gruff']},{sp:'ph',words:['photo','phone','phrase','dolphin','elephant']}],
  ...
  { id:'cons_s', num:31, ipa:'s', name:'S',  sub:'Voiceless Fricative', cat:'fr', file:'cons_s',
    ...
    patterns:[{sp:'s',words:['sun','bus','sad','sit']},{sp:'ss',words:['miss','class','dress','cross']},{sp:'c',words:['city','cell','rice','nice']},{sp:'sc',words:['scene','science']},{sp:'ps',words:['psyche','psalm']},{sp:'x',words:['tax','fox']},{sp:'ce',words:['place','face']},{sp:'se',words:['please','mouse']},{sp:'cy',words:['bicycle','fancy']}]},{sp:'ss',words:['miss','class','dress','cross','press','grass']},{sp:'c',words:['city','cell','rice','face','place','space','nice']}],
  ...
  { id:'cons_z', num:32, ipa:'z', name:'Z',  sub:'Voiced Fricative',   cat:'fr', file:'cons_z',
    ...
    patterns:[{sp:'z',words:['zip','zoo','zero','zone']},{sp:'zz',words:['buzz','jazz']},{sp:'s',words:['dogs','rose','nose','easy']},{sp:'se',words:['cheese','these']},{sp:'ze',words:['squeeze','breeze']},{sp:'x',words:['xylophone']}]},{sp:'s',words:['dogs','runs','beds','rose','nose','those','easy','busy']}],
  ...
  { id:'cons_sh', num:33, ipa:'ʃ', name:'SH', sub:'Voiceless Fricative', cat:'fr', file:'cons_sh',
    ...
    patterns:[{sp:'sh',words:['ship','shoe','fish','wish']},{sp:'ch',words:['chef','machine']},{sp:'ti',words:['nation','station','action','mention']},{sp:'ssi',words:['mission','passion']},{sp:'ci',words:['special','social','official','ancient']},{sp:'si',words:['tension','version']},{sp:'s',words:['sugar','sure']}]},{sp:'ti',words:['nation','station','action','section','mention']},{sp:'ci',words:['special','social','official','ancient']}],
  ...
  { id:'cons_zh', num:34, ipa:'ʒ', name:'ZH', sub:'Voiced Fricative',   cat:'fr', file:'cons_zh',
    ...
    patterns:[{sp:'si',words:['vision','decision','television','revision']},{sp:'su',words:['measure','treasure','pleasure','leisure']},{sp:'ge',words:['beige','mirage','garage','camouflage']},{sp:'z',words:['azure','seizure']},{sp:'g',words:['genre']}]},{sp:'su',words:['measure','treasure','pleasure','leisure','closure']},{sp:'ge',words:['beige','mirage','garage','massage','camouflage']}],
  ...
  { id:'cons_ch', num:36, ipa:'tʃ', name:'CH', sub:'Voiceless Affricate', cat:'af', file:'cons_ch',
    ...
    patterns:[{sp:'ch',words:['chair','chip','teach','church']},{sp:'tch',words:['catch','match','watch','fetch']},{sp:'t',words:['picture','future','creature','feature']},{sp:'ture',words:['nature','culture']}]},{sp:'tch',words:['catch','match','watch','fetch','hatch','patch','ditch','witch']},{sp:'t',words:['nature','future','picture','creature','feature']}],
  ...
  { id:'cons_j', num:37, ipa:'dʒ', name:'J',  sub:'Voiced Affricate',   cat:'af', file:'cons_j',
    ...
    patterns:[{sp:'j',words:['jump','jar','joy','just']},{sp:'g',words:['giant','gem','gentle','giraffe']},{sp:'dge',words:['bridge','hedge','judge','ridge']},{sp:'ge',words:['cage','huge']},{sp:'gy',words:['gym','allergy']},{sp:'di',words:['soldier','gradual']}]},{sp:'g',words:['giant','gem','gentle','gym','giraffe','ginger','page','age']},{sp:'dge',words:['bridge','hedge','ledge','fudge','judge','lodge','edge','ridge']}],
  ...
  { id:'cons_m', num:38, ipa:'m', name:'M',  sub:'Nasal',              cat:'na', file:'cons_m',
    ...
    patterns:[{sp:'m',words:['mat','me','ham','mud']},{sp:'mm',words:['hammer','summer','swimmer','comment']},{sp:'mb',words:['lamb','comb','thumb','climb']},{sp:'mn',words:['column','autumn']},{sp:'me',words:['come','some']}]},{sp:'mm',words:['hammer','summer','swimmer','shimmer','comment']},{sp:'mb',words:['lamb','comb','thumb','climb','bomb','dumb','limb']}],
  ...
  { id:'cons_n', num:39, ipa:'n', name:'N',  sub:'Nasal',              cat:'na', file:'cons_n',
    ...
    patterns:[{sp:'n',words:['net','no','ten','nap']},{sp:'nn',words:['running','dinner','winner','connect']},{sp:'kn',words:['know','knee','knife','knock']},{sp:'gn',words:['gnome','gnaw']},{sp:'ne',words:['phone']}]},{sp:'nn',words:['running','dinner','winner','inner','connect']},{sp:'kn',words:['know','knee','knife','knock','knot','kneel','knight']}],
  ...
  { id:'cons_ng', num:40, ipa:'ŋ', name:'NG', sub:'Nasal',              cat:'na', file:'cons_ng',
    ...
    patterns:[{sp:'ng',words:['king','ring','long','song']},{sp:'n',words:['think','bank','sink','drink']},{sp:'nk',words:['think','drink']}]},{sp:'n',words:['think','bank','tank','sink','link','drink','chunk','rank']}],
  ...
  { id:'cons_l', num:41, ipa:'l', name:'L',  sub:'Lateral Approximant', cat:'ap', file:'cons_l',
    ...
    patterns:[{sp:'l',words:['leg','tall','let','lip']},{sp:'ll',words:['bell','fill','well','hill']},{sp:'le',words:['table','bottle','little','people']},{sp:'al',words:['camel','capital']},{sp:'il',words:['pencil','fossil']}]},{sp:'ll',words:['tall','bell','fill','dull','bull','well','hill','pull','ball','cell']},{sp:'le',words:['table','bottle','little','people','needle','middle']}],
  ...
  { id:'cons_r', num:42, ipa:'r', name:'R',  sub:'Approximant',         cat:'ap', file:'cons_r',
    ...
    patterns:[{sp:'r',words:['red','run','rain','rug']},{sp:'rr',words:['carrot','carry','arrow','mirror']},{sp:'wr',words:['write','wrong','wrap','wrist']},{sp:'rh',words:['rhino','rhythm']}]},{sp:'rr',words:['carrot','carry','arrow','error','mirror','sorry','hurry']},{sp:'wr',words:['write','wrong','wrap','wrist','wreck','wrestle']}],
  ...
  { id:'cons_w', num:43, ipa:'w', name:'W',  sub:'Approximant',         cat:'ap', file:'cons_w',
    ...
    patterns:[{sp:'w',words:['water','wet','swim','win']},{sp:'wh',words:['when','where','which','wheel']},{sp:'u',words:['queen','quiet']},{sp:'o',words:['one','once']}]},{sp:'wh',words:['when','where','which','while','why','wheat','wheel','white']}],
  ...
  { id:'cons_y', num:44, ipa:'j', name:'Y',  sub:'Approximant',         cat:'ap', file:'cons_y',
    ...
    patterns:[{sp:'y',words:['yes','yet','yell','year']},{sp:'u',words:['use','unit','uniform','useful']},{sp:'ew',words:['new','few','dew','skew']},{sp:'eu',words:['feud','Europe']}]},{sp:'u',words:['use','unit','uniform','union','unique','universe','useful']},{sp:'ew',words:['new','view','fewer','skew']}],
